 ...
 $.ajax(settings).done(function (response) {
   swal("Deleted!", "Appointment has been deleted.", "success");
    ...
    function getAppointment() {
        ...
        response[i].doc_fullname=response[i].user_first_name+" "+response[i].user_last_name
        }
...
var doctorSelect=""
 function getDoctor() {
        ...
        response[i].doc_fullname=response[i].user_first_name+" "+response[i].user_last_name
        doctorSelect +="<option value="+response[i].user_id+">"+response[i].doc_fullname+"</option>"
        }
